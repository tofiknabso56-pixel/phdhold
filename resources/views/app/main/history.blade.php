...
<head>
    ...
    <style>
        .funding-container[data-v-5ee8c0bf] {
    width: 100%;
}
    </style>
</head>
...
<div data-v-cfeb29f2="" id="app">
    ...
    <div data-v-cfeb29f2="" id="Layout" class="layout" style="height: 727px;">
            ...
            <div class="header back-f0 ">
                <div class="van-nav-bar custome-white">
                    <div class="van-nav-bar__content">
                        ...
                        <div class="van-nav-bar__title van-ellipsis">Funding details</div>
                    </div>
                </div>
            </div>
        ...
        <div data-v-5ee8c0bf="" class="funding-container child-view">
            <div data-v-5ee8c0bf="" class="funding-balance">
                <div data-v-5ee8c0bf="" class="funding-balance-title">
                    Current balance：
                </div>
                <div data-v-5ee8c0bf="" class="funding-balance-jine">{{price(auth()->user()->balance)}}</div>
            </div>
            <div data-v-5ee8c0bf="" class="funding-padding">
                <div data-v-5ee8c0bf="" class="van-tabs van-tabs--card">
                        ...
                        <div class="van-sticky">
                            <div class="van-tabs__wrap">
                                <div role="tablist" class="van-tabs__nav van-tabs__nav--card">
                                    <div role="tab" aria-selected="true" class="van-tab van-tab--active" onclick="history1(this)"><span class="van-tab__text van-tab__text--ellipsis">All History</span></div>
                                    <div role="tab" class="van-tab" onclick="history2(this)"><span class="van-tab__text van-tab__text--ellipsis">Recharge</span></div>
                                    <div role="tab" class="van-tab" onclick="history3(this)"><span class="van-tab__text van-tab__text--ellipsis">Withdraw</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="van-tabs__content" id="tab3" style="display: none;">
                        <div data-v-5ee8c0bf="" role="tabpanel" class="van-tab__pane" style="">
